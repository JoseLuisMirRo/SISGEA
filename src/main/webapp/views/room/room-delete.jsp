...
<div class="modal fade" id="deleteRoomModal" data-bs-backdrop="static" aria-labelledby="deleteRoomTitle" aria-hidden="true">
        ...
        <div class="modal-content">
            <div class="modal-body">
                <div class="text-center">
                    ...
                    <h3>¿Desea inhabilitar espacio?</h3>
                </div>
...
<%--REVERIR DELETE--%>
<div class="modal fade" id="revertDeleteRoomModal" data-bs-backdrop="static" tabindex="-1" aria-labelledby="revertDeleteRoomTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-body">
                <div class="text-center">
