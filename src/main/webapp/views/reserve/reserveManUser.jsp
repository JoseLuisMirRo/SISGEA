...
<body>
<jsp:include page="/views/reserve/data-table-reserve-user.jsp"></jsp:include>

<!--MODAL AGREGAR RESERVA-->
<jsp:include page="/views/reserve/reserve-add.jsp"></jsp:include> <!--Compartido con el administrador-->
